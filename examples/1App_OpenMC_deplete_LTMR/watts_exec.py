...
# params['cross_sections_xml_location'] = '/Users/hannbn/openmc_data/endfb-viii.0-hdf5/cross_sections.xml'
...
# # fuel_pin_count = sum(row.count(fuel_pin) for row in rings)
