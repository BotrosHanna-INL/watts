...
def build_openmc_model(params):
    ...
    # I added the corss sections file here
    openmc.config['cross_sections'] = "/home/hannbn/projects/MARVEL_MRP/Github_repos/watts/openmc_data/endfb-viii.0-hdf5/cross_sections.xml"
