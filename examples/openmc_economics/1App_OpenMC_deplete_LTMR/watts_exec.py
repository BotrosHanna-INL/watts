...
# Function to define user parameters
def define_parameters():
    ...
    params['simplified_chain_thermal_xml'] = '/home/hannbn/projects/MARVEL_MRP/Github_repos/openmc_data/simplified_thermal_chain11.xml'
    ...
    params['Drum_Radius'] = params['drum_radius_to_lattice_radius'] * params['lattice_radius']
    ...
    params['all_drums_volume'], params['drum_absorp_all_mass'], params['drum_refl_all_mass'] = calculate_drum_volume(
        params['Drum_Radius'], params['drum_height'], params['drum_Absorber_thickness'], params['angle_between_drums_pairs'])
    params['tot_drum_area_all'] = params['all_drums_volume'] / params['drum_height']
    
    params['burnup_steps_MWd_per_Kg'] = [0.1, 0.2, 0.5, 1.0, 2.0, 5.0, 10.0, 15.0, 20.0, 30.0, 40.0, 50.0, 60.0, 80.0, 100.0, 120.0, 140.0]
    ...
    params['heat_flux'] = calculate_heat_flux(params['fuel_pin_radii'][-1], params['lattice_height'], params['rings'], params['power_MW_th'])
