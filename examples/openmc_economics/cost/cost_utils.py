...
# # All these costs need to be adjusted for inflation at some point (to 2024$)
def adjust_for_inflation(cost_and_dollar_year):
    ...
    if dollar_year == 2021:
        adjusted_cost  = raw_cost* 1.074 # 2024 dollars
